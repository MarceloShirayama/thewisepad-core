## theWisePad | Esta é uma API de um back-end para um aplicativo de bloco de notas simples. Foi escrito em Node.js e TypeScript seguindo os princípios da Clean Architecture.
